        ...
        <div class="col-md-6 mt-5 pt-5">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <p class="text-center text-muted mt-5 mb-0">Already had an account? 
                    <a href="login-form.php">Login here</a></p>
                </form>
               
        </div>
        <div class="col-6">
                    <img src="https://img.freepik.com/free-vector/cyber-attack-concept-illustration_114360-2067.jpg?size=626&ext=jpg&ga=GA1.1.1841514627.1686724360&semt=ais" height="500px" width="500px">
                </div>
        </div>
    </div>
