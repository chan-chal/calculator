                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="pas"
                                        class="btn btn-primary btn-block btn-md gradient-custom-4"><a style="color:white;text-decoration:none;"href="password_update.php?id=<?php echo $details['id'] ?>">Update password</a></button>
                                </div>
                                <!-- <div>
