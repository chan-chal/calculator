          ...
          <div class="card formmargin" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <form action="" method="POST">
                ...
                <input type="password" class="form-control" name="oldpass" id="myInput3" value="<?php echo $oldpassword  ?>" placeholder="Old password" required  maxlength="32">
                <div class="input-group-append">
                <button class="btn btn-secondary" type="button" onclick="myFunction3()"><i class="fa fa-eye" aria-hidden="true"></i></button>
                </div>
                </div>
                <div class="row">
                ...
                <div class="input-group">
                <input type="password" class="form-control" name="newpass" id="myInput1" placeholder="New password" value="<?php echo $newpassword  ?>" required  maxlength="32">
                <div class="input-group-append">
                ...
                <div class="input-group">
                <input type="password" class="form-control" name="renewpass" id="myInput2" value="<?php echo $renewpassword  ?>" placeholder="Confirm Newpassword" required  maxlength="32">
                <div class="input-group-append">
                ...
                <div class="d-flex justify-content-center">
                  <button type="submit" name="update" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body"><a class="modal-button">Update Password</a></button>
                </div>
              </form>
            </div>
          </div>
