                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="update"
                                        class="btn btn-success btn-block btn-lg gradient-custom-4 text-white">Update</button>
                                </div>
                                  <br>
                                <div class="d-flex justify-content-center">
                                    <button type="submit" name="pas"
                                        class="btn btn-primary btn-block btn-lg gradient-custom-4"><a style="color:white;text-decoration:none;"href="password_update.php?id=<?php echo $details['id'] ?>">Update password</a></button>
                                </div>
                                <!-- <div>
                                    <a href="password_update.php?id=">Update
                                        password</a>
                                </div> -->
                            </form>
                        </div>
